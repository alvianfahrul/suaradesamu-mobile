...
export default function Nayla() {
  ...
  useEffect(() => {
    // Simulasi pengambilan data dari API (misalnya)
    const fetchData = async () => {
      try {
        // Ganti dengan pemanggilan API sesuai kebutuhan Anda
        ...
        >
          <View style={styles.container}>
            <View style={styles.id_card}>
              <Image
                source={{ uri: "https://dory-liberal-uniformly.ngrok-free.app/profile/PP_Nayla.png" }}
                style={styles.image}
              />
              <Text style={styles.nama}>Nayla</Text>
              <Text style={styles.jabatan}>
                Member of XYZ Organization
              </Text>
              <Text style={styles.tahun}>32 Tahun</Text>
              ...
              <View>
                ...
                <View style={[styles.detail_card, { height: "auto" }]}>
                  ...
                  <View style={{ marginLeft: "5%" }}>
                    ...
                    <Text
                      style={[styles.detail_title_2, { marginLeft: "6.5%" }]}
                    >
                ...
                <View style={[styles.detail_card, { height: "auto" }]}>
                  ...
                  <View style={{ marginLeft: "5%" }}>
                    ...
                    <Text
                      style={[styles.detail_title_2, { marginLeft: "6.6%" }]}
                    >
